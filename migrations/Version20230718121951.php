 ...
 */
final class Version20230718121951 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employes CHANGE salaire salary DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE employes CHANGE salary salaire DOUBLE PRECISION DEFAULT NULL');
    }
}
